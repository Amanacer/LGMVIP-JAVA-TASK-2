...
public class scientificcalculator {
    ...
    private void initialize() {
        ...
        JLabel lblNewLabel1 = new JLabel("SCIENTIFIC CALCULATOR");
        lblNewLabel1.setBounds(10, 11, 320, 27);
        lblNewLabel1.setFont(new Font("Tahoma", Font.BOLD, 24));
        ...
        btDot.setFont(new Font("Tahoma", Font.PLAIN, 21));
        ...
        btn9.setFont(new Font("Tahnoma", Font.BOLD, 23));
        ...
        btn3.setFont(new Font("Tahnoma", Font.BOLD, 23));
        ...
        btnTan_1.setFont(new Font("Tahnoma", Font.PLAIN, 13));
        ...
        btnPlus.setFont(new Font("Tahnoma", Font.PLAIN, 13));
        ...
        btnSub.setFont(new Font("Tahnoma", Font.PLAIN, 21));
        btnSub.setForeground(Color.white);
        btnSub.setBackground(Color.black);
        btnSub.setBounds(266, 295, 64, 50);
        frame.getContentPane().add(btnSub);
        JButton btnMu1 = new JButton("*");
        btnMu1.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                first = Double.parseDouble(textField.getText());
                textField.setText("");
        ...
        btnMu1.setFont(new Font("Tahnoma", Font.PLAIN, 21));
        btnMu1.setForeground(Color.white);
        btnMu1.setBackground(Color.black);
        btnMu1.setBounds(266, 347, 64, 50);
        frame.getContentPane().add(btnMu1);
        ...
        btnDivide.setFont(new Font("Tahnoma", Font.PLAIN, 21));
        ...
        btnP_1.setFont(new Font("Tahnoma", Font.PLAIN, 16));
        ...
        btnN.setFont(new Font("Tahnoma", Font.PLAIN, 18));
        ...
        jSeparator_2.setBounds(10, 191, 320, 2);
        frame.getContentPane().add(jSeparator_2);
